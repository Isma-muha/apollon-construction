        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            <div className="rounded-lg overflow-hidden border border-cream-3">
              <img src="/images/toiture-ardoise.jpg" alt="Toiture ardoise rénovée Apollon Construction" className="w-full h-56 object-cover" loading="lazy" />
            </div>
            <div className="rounded-lg overflow-hidden border border-cream-3">
              <img src="/images/toiture-plate.jpg" alt="Toiture plate étanchéité Bruxelles" className="w-full h-48 object-cover" loading="lazy" />
            </div>
